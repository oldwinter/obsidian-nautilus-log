...
export const enExecution: ExecutionCatalog = Object.freeze({
  ...
  "timing.forgotten": "This CLOCK may have been left running. Forgotten is a warning only — use Clock out when you stop.",
  "timing.pomo": "POMO",
  ...
  "notice.taskLinkCopied": "Task link copied.",
  ...
  "error.copyTaskLink": "The task link could not be copied. Use Locate Primary Plan to open today's Daily Note and copy the wikilink from the task line. If the block ID is missing, Clock In from the Plan tab first.",
