...
export const enReview: ReviewCatalog = Object.freeze({
  ...
  "state.missingNote": "No Daily Note exists for this date. Create the note that matches Settings → Daily Note folder and date format.",
  "state.missingPlan": "This Daily Note has no Primary Plan. Add `<!-- nautilus-log:plan/v1 -->` and `<!-- /nautilus-log:plan -->` at column zero, then save.",
