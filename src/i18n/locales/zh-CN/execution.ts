...
export const zhCNExecution: ExecutionCatalog = Object.freeze({
  ...
  "settings.dailyNoteFolderDesc": "今日日记的库内相对目录。留空表示库根目录。必须和「写入今日日记」创建、规划器读取的笔记一致。",
  "settings.dailyNoteFormat": "日记日期格式",
  "settings.dailyNoteFormatDesc": "日记文件名的日期格式，必须包含年、月、日标记。插件会补上 .md。",
  "settings.onboardingTitle": "第一次使用清单",
  "settings.onboardingExecution": "在下方启用执行层后，才能打开计时、计划、回顾、命令面板操作和右侧栏当前任务。",
  "notice.firstRun": "还没有主计划。可在规划器、设置或回顾（今天）里点「写入今日日记」，或自行粘贴 nautilus-log:plan/v1 标记。",
