...
export const zhCNExecution: ExecutionCatalog = Object.freeze({
  ...
  "settings.onboardingExecutionOn": "执行层已启用。用左侧功能区的「执行」打开计时、计划和回顾，右侧栏打开当前任务。",
  ...
  "error.copyTaskLink": "无法复制任务链接。请用「定位主计划」打开今日日记，从任务行复制双向链接。如果还没有区块 ID，请先在「计划」标签开始计时。",
  "error.unconfirmed": "无法确认笔记更改。请保存、刷新后再试。",
  "error.pluginData": "无法保存插件设置或番茄钟会话。请再试一次开始计时、结束计时，或刚才改的设置。如果还是失败，请确认库可以写入。",
